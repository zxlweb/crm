...
import type { ChartBarItem } from '~/types/chart'
...
const props = withDefaults(
  ...
  { height: 280, horizontal: true, animated: true },
)

const { colors, baseGrid, barTooltip, categoryAxis, valueAxis, valueAxisWithGrid } = useChartTheme()
