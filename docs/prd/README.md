...
| [phase-3-deals-dashboard-prd.md](./phase-3-deals-dashboard-prd.md) | Phase 3 商机 Pipeline + Dashboard + **部门数据范围/分角色工作台** | v0.3 |
| [phase-4-system-settings-close-prd.md](./phase-4-system-settings-close-prd.md) | Phase 4 系统设置、**登录/租户会话**、角色权限、**成员按 scope 过滤** | v0.4 |
